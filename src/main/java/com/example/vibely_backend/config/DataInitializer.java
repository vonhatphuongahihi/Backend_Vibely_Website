...
public class DataInitializer implements CommandLineRunner {
    ...
    private void addStaticTrainingData() {
        ...
        chatbotService.addTrainingData(
                "Làm sao để tham gia một Quiz?",
                "Để tham gia một Quiz: 1) Tìm kiếm Quiz bạn muốn tham gia, 2) Nhấn vào Quiz đó, 3) Trả lời các câu hỏi, 4) Xem kết quả sau khi hoàn thành.",
                "how-to-take-quiz",
                Arrays.asList("participate-in-quiz", "answer-quiz-questions"));
